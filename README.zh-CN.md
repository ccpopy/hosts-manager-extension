...
- 批量导入示例：
  ...
  ```
- Socket 代理：设置页 → Socket 代理，可新建和编辑多套命名配置。选择一套当前配置后，通过总开关启用/停用代理，也可在工具栏弹窗中快速切换配置。
- JSON 备份可包含代理配置；默认不导出代理密码，导入后代理保持关闭，需手动确认启用。
...
感谢所有通过测试、反馈和 Pull Request 帮助改进项目的贡献者：

| 贡献者                                     | 贡献内容          |
| ------------------------------------------ | ----------------- |
| [@Jaffe2718](https://github.com/Jaffe2718) | Issue 反馈 & 测试 |

> 想加入这个列表？欢迎通过 [Issues](https://github.com/ccpopy/hosts-manager-extension/issues) 或 [Pull Requests](https://github.com/ccpopy/hosts-manager-extension/pulls) 参与贡献！
...
<a href="https://star-history.com/#ccpopy/hosts-manager-extension&Date">
 <picture>
   ...
   <img alt="Star 历史图表" src="https://api.star-history.com/svg?repos=ccpopy/hosts-manager-extension&type=Date" />
 </picture>
</a>
